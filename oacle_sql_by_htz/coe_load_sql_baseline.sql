...
REM
REM $Header: 215187.1 coe_load_sql_baseline.sql 11.4.4.1 2012/01/02 carlos.sierra $
REM
...
REM      data dictionary and privileges to create SQL Plan Baselines.
...
SELECT 'SYSTEM' connected_user FROM DUAL;
...
/*导出spm到中间表
  ...
  BEGIN
    ...
    EXECUTE IMMEDIATE 'DROP TABLE SYSTEM.STGTAB_BASELINE_'||UPPER(TRIM('&&original_sql_id.'));
  EXCEPTION
    WHEN OTHERS THEN
