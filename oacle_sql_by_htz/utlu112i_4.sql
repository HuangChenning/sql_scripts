Rem
Rem $Header: rdbms/admin/utlu112i.sql st_server_cmlim_autlu112i_add_tablespace_sizing_fixes/1 2012/05/01 17:56:14 cmlim Exp $
Rem
Rem utlu112i.sql
Rem
...
Rem    cmlim       04/25/12 - add 11203 RELEASE fixes
Rem                         - bug 13968961 - backport
Rem                           cmlim_preupg_tblspace_sizes from 12.1
...
-- *****************************************************************
  ...
  utlu_buildrev    CONSTANT VARCHAR2(3)  := '005';
