prompt 
prompt +--------------------------------------------------------------------------------+
prompt |                 EnmoTech Health Check Report 10g Release 2                     |
prompt |--------------------------------------------------------------------------------+
...
define reportHeader="<font size=+3 color=darkgreen><b>EnmoTech Health Check Report 10gR2 (Basic Edition)</b></font><hr>Copyright (c) 2012-2012 Hongye DBA. All rights reserved. (<a target=""_blank"" href=""http://www.enmotech.com"">www.enmotech.com</a>)<p>"
...
define fileName=enmotech_report_10.2
...
<table width="90%" border="1">
prompt  <tr><th colspan="4">Database and Instance Information</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#report_header">Report Header</a></td> <td nowrap align="center" width="25%"><a class="link" href="#version">Version</a></td> <td nowrap align="center" width="25%"><a class="link" href="#initialization_parameters">Initialization Parameters</a></td> <td nowrap align="center" width="25%"><a class="link" href="#redo_log_switches">Redo Log Switches</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#control_files">Control Files</a></td> <td nowrap align="center" width="25%"><a class="link" href="#database_instance_overview">Database Instance Overview</a></td> <td nowrap align="center" width="25%"><a class="link" href="#online_redo_logs">Online Redo Logs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#scn_report">SCN Report</a></td> </tr> <tr><th colspan="4">Storage</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#tablespaces">Tablespaces</a></td> <td nowrap align="center" width="25%"><a class="link" href="#data_files">Data Files</a></td> <td nowrap align="center" width="25%"><a class="link" href="#tablespace_to_owner">Tablespace to Owner</a></td> <td nowrap align="center" width="25%"><a class="link" href="#asm_disk">ASM Disk</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#asm_diskgroup">ASM Diskgroup</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">UNDO Segments</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#undo_retention_parameters">UNDO Retention Parameters</a></td> <td nowrap align="center" width="25%"><a class="link" href="#undo_segment_contention">UNDO Segment Contention</a></td> <td nowrap align="center" width="25%"><a class="link" href="#undo_segments">UNDO Segments</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Backups</th></tr> <tr>

prompt <td nowrap align="center" width="25%"><a class="link" href="#rman_backup_control_files">RMAN Backup Control Files</a></td> <td nowrap align="center" width="25%"><a class="link" href="#rman_backup_pieces">RMAN Backup Pieces</a></td> <td nowrap align="center" width="25%"><a class="link" href="#rman_backup_sets">RMAN Backup Sets</a></td> <td nowrap align="center" width="25%"><a class="link" href="#rman_backup_spfile">RMAN Backup SPFILE</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#rman_configuration">RMAN Configuration</a></td> <td nowrap align="center" width="25%"><a class="link" href="#flash_recovery_area_parameters">Flash Recovery Area Parameters</a></td> <td nowrap align="center" width="25%"><a class="link" href="#flash_recovery_area_status">Flash Recovery Area Status</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Objects</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#invalid_objects">Invalid Objects</a></td> <td nowrap align="center" width="25%"><a class="link" href="#objects_in_the_system_tablespace">Objects in the SYSTEM Tablespace</a></td> <td nowrap align="center" width="25%"><a class="link" href="#tables_suffering_from_row_chaining_migration">Tables Suffering From Row Chaining/Migration</a></td> <td nowrap align="center" width="25%"><a class="link" href="#top_10_segments_by_size">Top 10 Segments (by size)</a></td> </tr></tr></table><p>
...
SELECT
    '<div align="center"><font color="#336699"><b>' || TO_CHAR(first_time, 'MM/DD') || '</b></font></div>'  DAY
...
prompt <a name="database_instance_overview"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Database Instance Overview</b></font><hr align="left" width="460">
...
prompt <a name="scn_report"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>SCN Report</b></font><hr align="left" width="460">
...
select tim, scn,
  ...
  from
 (select sysdate tim,dbms_flashback.get_system_change_number scn from dual))
ORDER BY tim;
...
COLUMN ts_size     FORMAT a30        HEADING 'Tablespace Size'   ENTMAP off
COLUMN free        FORMAT a30        HEADING 'Free Size'   ENTMAP off
COLUMN used        FORMAT a30        HEADING 'Used SIze'   ENTMAP off
COLUMN pct_used                                HEADING 'Pct. Used'         ENTMAP off

SELECT
    DECODE(   d.status
            , 'OFFLINE' , '<div align="center"><b><font color="#990000"> Offline </font></b></div>'
  ...
  , case when nvl(a.bytes,0)<1048576 then '<div align="right">'|| round(nvl(a.bytes,0)/1024)||' KB</div>'
		 when a.bytes<1073741824 then '<div align="right">'|| round(a.bytes/1048576)||' MB</div>'
		 else '<div align="right">'|| round(a.bytes/1073741824) ||' GB</div>' end ts_size
  , case when nvl(f.bytes,0)<1048576 then '<div align="right">'|| round(nvl(f.bytes,0)/1024)||' KB</div>'
		 when f.bytes<1073741824 then '<div align="right">'|| round(f.bytes/1048576)||' MB</div>'
		 else '<div align="right">'|| round(f.bytes/1073741824) ||' GB</div>' end free
  , case when (a.bytes-NVL(f.bytes,0))<1048576 then '<div align="right">'|| round((a.bytes-NVL(f.bytes,0))/1024)||' KB</div>'
		 when (a.bytes-NVL(f.bytes,0))<1073741824 then '<div align="right">'|| round((a.bytes-NVL(f.bytes,0))/1048576)||' MB</div>'
		 else '<div align="right">'|| round((a.bytes-NVL(f.bytes,0))/1073741824) ||' GB</div>' end used
  , '<div align="right"><b>' || 
          DECODE (
...
COLUMN tablespace      FORMAT A50         HEADING 'Tbs Name / File Class'         ENTMAP off
...
SELECT /*+ ordered */
    '<font color="#336699"><b>' || tablespace_name  || '</b></font>'  tablespace
  , '<tt>' || file_name || '</tt>'                                    filename
  , case when bytes<1048576 then '<div align="right">'|| round(bytes/1024)||' KB</div>'
		 when bytes<1073741824 then '<div align="right">'|| round(bytes/1048576)||' MB</div>'
		 else '<div align="right">'|| round(bytes/1073741824) ||' GB</div>' end         filesize
  , case status when 'AVAILABLE' then '<font color=darkgreen> Available </font>'
                else '<font color=red>'||status||'</font>' end status
  , '<div align="center">' || NVL(autoextensible, '<br>') || '</div>' autoextensible
  , case when nvl(maxbytes,0)<1048576 then '<div align="right">'|| round(nvl(maxbytes,0)/1024)||' KB</div>'
		 when maxbytes<1073741824 then '<div align="right">'|| round(maxbytes/1048576)||' MB</div>'
		 else '<div align="right">'|| round(maxbytes/1073741824) ||' GB</div>' end      maxbytes
FROM dba_data_files
UNION all
SELECT '<font color="#336699"><b>' || tablespace_name  || '</b></font>'  tablespace
  , '<tt>' || file_name || '</tt>'                                    filename
  , case when bytes<1048576 then '<div align="right">'|| round(bytes/1024)||' KB</div>'
		 when bytes<1073741824 then '<div align="right">'|| round(bytes/1048576)||' MB</div>'
		 else '<div align="right">'|| round(bytes/1073741824) ||' GB</div>' end         filesize
...
SELECT
    '<font color="#336699"><b>'  || disk_number    || '</b></font>' disk_number
  , decode(a.state,'CONNECTED','<font color=darkgreen><b>'|| a.state    || '</b></font>'
                ,'MOUNTED','<font color="#336699"><b>'    || a.state    || '</b></font>'
                ,'DISMOUNTED','<font color=darkred><b>'   || a.state    || '</b></font>'
                ,'<font color=red><b>'                    || a.state    || '</b></font>') state
  , b.name group_name
  , a.name disk_name
  , a.path
  , round(a.total_mb/1024) total_gb
  , round(a.free_mb/1024) free_gb
  , case when round(a.free_mb/a.total_mb*100)>90 then
              '<font color=red><b>'   || round(a.free_mb/a.total_mb*100) || '</b></font>'
         when round(a.free_mb/a.total_mb*100)<50 then
              '<font color=GREEN><b>' || round(a.free_mb/a.total_mb*100) || '</b></font>' 
         else '<b>'                   || round(a.free_mb/a.total_mb*100) || '</b>'
    end free_percent
FROM
    V$ASM_DISK A,V$ASM_DISKGROUP B 
...
SELECT
    '<font color="#336699"><b>'  || group_number    || '</b></font>' group_number
  , decode(state,'CONNECTED','<font color=darkgreen><b>'|| state    || '</b></font>'
                ,'MOUNTED','<font color="#336699"><b>'  || state    || '</b></font>'
                ,'DISMOUNTED','<font color=darkred><b>' || state    || '</b></font>'
                ,'<font color=red><b>'                  || state    || '</b></font>') state
  , name
  , round(total_mb/1024) total_gb
  , round(free_mb/1024) free_gb
  , case when round(free_mb/total_mb*100)>90 then
              '<font color=red><b>'   || round(free_mb/total_mb*100) || '</b></font>'
         when round(free_mb/total_mb*100)<50 then
              '<font color=GREEN><b>' || round(free_mb/total_mb*100) || '</b></font>' 
         else '<b>'                   || round(free_mb/total_mb*100) || '</b>'
    end free_percent
FROM
    v$ASM_DISKGROUP
ORDER BY
...
SELECT
  ...
  , (CASE p.name
         WHEN 'undo_retention' THEN '<div nowrap align="right">' || TO_CHAR(TO_NUMBER(p.value)/60, '999,999,999,999,999') || ' Min </div>'
     ELSE
...
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Top 10 Segments (by size)</b></font><hr align="left" width="460">
...
-- +----------------------------------------------------------------------------+
define reportHeader="<font size=+3 color=darkgreen><b>EnmoTech Health Check Report 10gR2 (Supplement Edition)</b></font><hr>Copyright (c) 2012-2012 Hongye DBA. All rights reserved. (<a target=""_blank"" href=""http://www.enmotech.com"">www.enmotech.com</a>)<p>"
...
prompt <center><font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Report Index</b></font><hr align="center" width="250"></center> -
<table width="90%" border="1">
prompt  <tr><th colspan="4">Database and Instance Information</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#feature_usage_statistics">Feature Usage Statistics</a></td> <td nowrap align="center" width="25%"><a class="link" href="#high_water_mark_statistics">High Water Mark Statistics</a></td> <td nowrap align="center" width="25%"><a class="link" href="#outstanding_alerts">Outstanding Alerts</a></td> <td nowrap align="center" width="25%"><a class="link" href="#options">Options</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#control_file_records">Control File Records</a></td> <td nowrap align="center" width="25%"><a class="link" href="#statistics_level">Statistics Level</a></td> <td nowrap align="center" width="25%"><a class="link" href="#database_registry">Database Registry</a></td> <td nowrap align="center" width="25%"><a class="link" href="#psu_history">PSU History</a></td> </tr> <tr><th colspan="4">Scheduler / Jobs</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#jobs">Jobs</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Storage</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#tablespace_extents">Tablespace Extents</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Backups</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#rman_backup_jobs">RMAN Backup Jobs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#archive_destinations">Archive Destinations</a></td> <td nowrap align="center" width="25%"><a class="link" href="#archiving_history">Archiving History</a></td> <td nowrap align="center" width="25%"><a class="link" href="#archiving_instance_parameters">Archiving Instance Parameters</a></td> </tr> <tr>
prompt <td nowrap align="center" width="25%"><a class="link" href="#archiving_mode">Archiving Mode</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Flashback Technologies</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#flashback_database_parameters">Flashback Database Parameters</a></td> <td nowrap align="center" width="25%"><a class="link" href="#flashback_database_redo_time_matrix">Flashback Database Redo Time Matrix</a></td> <td nowrap align="center" width="25%"><a class="link" href="#flashback_database_status">Flashback Database Status</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_recycle_bin">Recycle Bin</a></td> </tr> <tr><th colspan="4">Performance</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#sga_asmm_dynamic_components">SGA (ASMM) Dynamic Components</a></td> <td nowrap align="center" width="25%"><a class="link" href="#sga_information">SGA Information</a></td> <td nowrap align="center" width="25%"><a class="link" href="#sga_target_advice">SGA Target Advice</a></td> <td nowrap align="center" width="25%"><a class="link" href="#sorts">Sorts</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#file_io_statistics">File I/O Statistics</a></td> <td nowrap align="center" width="25%"><a class="link" href="#file_io_timings">File I/O Timings</a></td> <td nowrap align="center" width="25%"><a class="link" href="#full_table_scans">Full Table Scans</a></td> <td nowrap align="center" width="25%"><a class="link" href="#sql_statements_with_most_buffer_gets">SQL Statements With Most Buffer Gets</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#sql_statements_with_most_disk_reads">SQL Statements With Most Disk Reads</a></td> <td nowrap align="center" width="25%"><a class="link" href="#average_overall_io_per_sec">Average Overall I/O per Second</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_outline_hints">Outline Hints</a></td>
prompt <td nowrap align="center" width="25%"><a class="link" href="#dba_outlines">Outlines</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#pga_target_advice">PGA Target Advice</a></td> <td nowrap align="center" width="25%"><a class="link" href="#redo_log_contention">Redo Log Contention</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_enabled_aggregations">Enabled Aggregations</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_enabled_traces">Enabled Traces</a></td> </tr> <tr><th colspan="4">Automatic Workload Repository</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#awr_baselines">AWR Baselines</a></td> <td nowrap align="center" width="25%"><a class="link" href="#awr_snapshot_list">AWR Snapshot List</a></td> <td nowrap align="center" width="25%"><a class="link" href="#awr_snapshot_settings">AWR Snapshot Settings</a></td> <td nowrap align="center" width="25%"><a class="link" href="#awr_snapshot_size_estimates">AWR Snapshot Size Estimates</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#awr_workload_repository_information">Workload Repository Information</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Sessions</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#current_sessions">Current Sessions</a></td> <td nowrap align="center" width="25%"><a class="link" href="#user_session_matrix">User Session Matrix</a></td> <td nowrap align="center" width="25%"><a class="link" href="#high_water">High Water</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Security</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#users_role">User Roles</a></td> <td nowrap align="center" width="25%"><a class="link" href="#user_accounts">User Accounts</a></td> <td nowrap align="center" width="25%"><a class="link" href="#user_obj">User Object Privileges</a></td>
prompt <td nowrap align="center" width="25%"><a class="link" href="#role_obj_privs">Role Object Privileges</td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#roles_user">Role Users</a></td> <td nowrap align="center" width="25%"><a class="link" href="#role_sys_privs">Role System Privileges</a></td> <td nowrap align="center" width="25%"><a class="link" href="#sys_user">System Privilege Users</a></td> <td nowrap align="center" width="25%"><a class="link" href="#user_sys">User System Privileges</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#db_links">DB Links</a></td> <td nowrap align="center" width="25%"><a class="link" href="#default_passwords">Default Passwords</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Objects</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#dba_collections">Collections</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_directories">Directories</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_directory_privileges">Directory Privileges</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_libraries">Libraries</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#dba_lob_segments">LOB Segments</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_type_attributes">Type Attributes</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_type_methods">Type Methods</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_types">Types</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#object_summary">Object Summary</a></td> <td nowrap align="center" width="25%"><a class="link" href="#objects_unable_to_extend">Objects Unable to Extend</a></td> <td nowrap align="center" width="25%"><a class="link" href="#objects_which_are_nearing_maxextents">Objects Which Are Nearing MAXEXTENTS</a></td> <td nowrap align="center" width="25%"><a class="link" href="#objects_without_statistics">Objects Without Statistics</a></td> </tr> <tr>
prompt <td nowrap align="center" width="25%"><a class="link" href="#owner_to_tablespace">Owner to Tablespace</a></td> <td nowrap align="center" width="25%"><a class="link" href="#procedural_object_errors">Procedural Object Errors</a></td> <td nowrap align="center" width="25%"><a class="link" href="#segment_summary">Segment Summary</a></td> <td nowrap align="center" width="25%"><a class="link" href="#top_100_segments_by_extents">Top 100 Segments (by number of extents)</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#users_with_default_tablespace_defined_as_system">Users With Default Tablespace (SYSTEM)</a></td> <td nowrap align="center" width="25%"><a class="link" href="#users_with_default_temporary_tablespace_as_system">Users With Default Temp Tablespace (SYSTEM)</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Partitions ( Table and Index)</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#part_index_detail">Partition Index Detail</a></td> <td nowrap align="center" width="25%"><a class="link" href="#part_index_summary">Partition Index Summary</a></td> <td nowrap align="center" width="25%"><a class="link" href="#part_table_detail">Partition Table Detail</a></td> <td nowrap align="center" width="25%"><a class="link" href="#part_table_summary">Partition Table Summary</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#list_no_default">List Partition Without Default</a></td> <td nowrap align="center" width="25%"><a class="link" href="#range_no_maxvalue">Range Partition Without MaxValue</a></td> <td nowrap align="center" width="25%"><a class="link" href="#global_ind_part_table">Global Indexes on Partition Table</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Online Analytical Processing - (OLAP)</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#dba_olap_materialized_view_logs">Materialized View Logs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#dba_olap_materialized_view_refresh_groups">Materialized View Refresh Groups</a></td>
prompt <td nowrap align="center" width="25%"><a class="link" href="#dba_olap_materialized_views">Materialized Views</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Data Pump</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#data_pump_job_progress">Data Pump Job Progress</a></td> <td nowrap align="center" width="25%"><a class="link" href="#data_pump_jobs">Data Pump Jobs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#data_pump_sessions">Data Pump Sessions</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Networking</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#mts_dispatcher_response_queue_wait_stats">MTS Dispatcher Response Queue Wait Stats</a></td> <td nowrap align="center" width="25%"><a class="link" href="#mts_dispatcher_statistics">MTS Dispatcher Statistics</a></td> <td nowrap align="center" width="25%"><a class="link" href="#mts_shared_server_wait_statistics">MTS Shared Server Wait Statistics</a></td>  <td nowrap align="center" width="25%"><a class="link" href="#"></a></td> </tr> <tr><th colspan="4">Replication</th></tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#replication_summary">Replication Summary</a></td> <td nowrap align="center" width="25%"><a class="link" href="#rep_initialization_parameters">Initialization Parameters</a></td> <td nowrap align="center" width="25%"><a class="link" href="#deferred_transactions">Deferred Transactions</a></td> <td nowrap align="center" width="25%"><a class="link" href="#administrative_request_jobs">Administrative Request Jobs</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#schedule_purge_jobs">(Schedule) Purge Jobs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#schedule_push_jobs">(Schedule) Push Jobs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#schedule_refresh_jobs">(Schedule) Refresh Jobs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#multimaster_master_groups_and_sites">(Multi-Master) Master Groups and Sites</a></td> </tr> <tr>

prompt <td nowrap align="center" width="25%"><a class="link" href="#multimaster_master_groups">(Multi-Master) Master Groups</a></td> <td nowrap align="center" width="25%"><a class="link" href="#materialized_view_groups">(Materialized View) Groups</a></td> <td nowrap align="center" width="25%"><a class="link" href="#materialized_view_master_site_logs">(Materialized View) Master Site Logs</a></td> <td nowrap align="center" width="25%"><a class="link" href="#materialized_view_master_site_summary">(Materialized View) Master Site Summary</a></td> </tr> <tr> <td nowrap align="center" width="25%"><a class="link" href="#materialized_view_master_site_templates">(Materialized View) Master Site Templates</a></td> <td nowrap align="center" width="25%"><a class="link" href="#materialized_view_materialized_views">(Materialized View) Materialized Views</a></td> <td nowrap align="center" width="25%"><a class="link" href="#materialized_view_refresh_groups">(Materialized View) Refresh Groups</a></td> <td nowrap align="center" width="25%"><a class="link" href="#materialized_view_summary">(Materialized View) Summary</a></td> </tr></tr></table><p>
...
SELECT
  ...
  , DECODE(   detected_usages
            , 0
            , '<div align="right">' || NVL(TO_CHAR(first_usage_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'
            , '<div align="right"><font color="#663300"><b>' || NVL(TO_CHAR(first_usage_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</b></font></div>')   first_usage_date
  , DECODE(   detected_usages
            , 0
            , '<div align="right">' || NVL(TO_CHAR(last_usage_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'
            , '<div align="right"><font color="#663300"><b>' || NVL(TO_CHAR(last_usage_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</b></font></div>')    last_usage_date
  , DECODE(   detected_usages
            , 0
            , '<div align="right">' || NVL(TO_CHAR(last_sample_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'
            , '<div align="right"><font color="#663300"><b>' || NVL(TO_CHAR(last_sample_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</b></font></div>')   last_sample_date
  , DECODE(   detected_usages
            , 0
            , '<div align="right">' || NVL(TO_CHAR((last_sample_date+SAMPLE_INTERVAL/60/60/24), 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'
            , '<div align="right"><font color="#663300"><b>' || NVL(TO_CHAR((last_sample_date+SAMPLE_INTERVAL/60/60/24), 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</b></font></div>')   next_sample_date
...
prompt <a name="psu_history"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>PSU History</b></font><hr align="left" width="460">
...
SELECT
    ACTION_TIME
  , ACTION
  , '<div align="center"><font color="#336699"><b>' || id || '</b></font></div>'  id
  , Namespace
  , '<font color=darkred><b>' || version ||'</b></font>' version
  , Comments
...
SELECT
  ...
  , name
  , first_change#
  , '<div align="right" nowrap>' || TO_CHAR(first_time, 'yyyy-mm-dd HH24:MI:SS') || '</div>' first_time
  , next_change#
  , '<div align="right" nowrap>' || TO_CHAR(next_time, 'yyyy-mm-dd HH24:MI:SS')  || '</div>' next_time
...
SELECT
    '<div align="right">' || TO_CHAR(begin_time,'yyyy-mm-dd HH24:MI:SS') || '</div>'  begin_time
  , '<div align="right">' || TO_CHAR(end_time,'yyyy-mm-dd HH24:MI:SS') || '</div>'    end_time
  , flashback_data
  , db_data
  , redo_data
...
SELECT
    '<div align="center"><font color="#336699"><b>' || TO_CHAR(oldest_flashback_time,'yyyy-mm-dd HH24:MI:SS') || '</b></font></div>'  oldest_flashback_time
...
SELECT 
  ...
  , a.sql_text                 sql_text
FROM 
    (SELECT ai.sql_id,ai.buffer_gets, ai.executions, ai.sql_text, ai.parsing_user_id
...
SELECT 
  ...
  , a.sql_text         sql_text
FROM 
    (SELECT ai.sql_id, ai.disk_reads, ai.executions, ai.sql_text, ai.parsing_user_id
     FROM sys.v_$sqlarea ai
     ORDER BY ai.buffer_gets
    ) a
  , dba_users b
...
SELECT
  ...
  , name
  , used
  , '<div nowrap align="right">' || TO_CHAR(timestamp, 'yyyy-mm-dd HH24:MI:SS') || '</div>' timestamp
  , version
  , sql_text
FROM
    dba_outlines
...
prompt <center><font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#663300"><b><u>Automatic Workload Repository</u></b></font></center>
...
SELECT
  ...
  , '<div nowrap align="right">' || TO_CHAR(b.start_snap_time, 'yyyy-mm-dd HH24:MI:SS')  || '</div>'  start_snap_time
  , b.end_snap_id                                                                   end_snap_id
  , '<div nowrap align="right">' || TO_CHAR(b.end_snap_time, 'yyyy-mm-dd HH24:MI:SS')  || '</div>'    end_snap_time
FROM
    dba_hist_baseline   b
  , v$database          d
WHERE
...
SELECT
  ...
  , '<div nowrap align="right">'                    || TO_CHAR(s.startup_time, 'yyyy-mm-dd HH24:MI:SS')        || '</div>'             startup_time
  , '<div nowrap align="right">'                    || TO_CHAR(s.begin_interval_time, 'yyyy-mm-dd HH24:MI:SS') || '</div>'             begin_interval_time
  , '<div nowrap align="right">'                    || TO_CHAR(s.end_interval_time, 'yyyy-mm-dd HH24:MI:SS')   || '</div>'             end_interval_time
...
prompt <a name="high_water"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>High Water</b></font><hr align="left" width="460">
...
prompt <a name="users_role"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>User Roles</b></font><hr align="left" width="460">
...
FROM
    dba_role_privs
WHERE
    Grantee not in (select name from user$ where type#=0)
and grantee not in (  'CTXSYS'
                      , 'DBSNMP'
                      , 'DMSYS'
                      , 'EXFSYS'
                      , 'IX'
...
SELECT 
    '<div nowrap align="right"><b><font color="black">' || user_id || '</font></b></div>'               user_id
  ...
  , '<div nowrap align="right">' || NVL(TO_CHAR(expiry_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'           expiry_date
  , default_tablespace                                                                                  default_tablespace
  , temporary_tablespace                                                                                temporary_tablespace
  , '<div nowrap align="right">' || TO_CHAR(created, 'yyyy-mm-dd HH24:MI:SS') || '</div>'               created
  , profile                                        profile
  , '<div nowrap align="center">' || NVL(DECODE(sysdba,'TRUE', 'TRUE',''), '<br>') || '</div>'   sysdba
  , '<div nowrap align="center">' || NVL(DECODE(sysoper,'TRUE','TRUE',''), '<br>') || '</div>'   sysoper
FROM
    (select user_id,u.username,account_status,expiry_date,default_tablespace,temporary_tablespace,created,profile,sysdba,sysoper
        from dba_users u,v$pwfile_users p 
...
prompt <a name="user_obj"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>User Object Privileges</b></font><hr align="left" width="460">
...
SELECT
   '<font color="black"><b>'  ||  grantee|| '</b></font>'          grantee
  , '<font color="black"><b>' ||  owner || '</b></font>'           owner
  , '<font color="darkgreen"><b>' ||  table_name || '</b></font>'  table_name
  , CASE WHEN privilege like 'DROP%' then
            '<div align="center"><font color="darkred"><b>' || privilege || '</b></font></div>'
         ELSE
            '<div align="center"><font color="darkgreen"><b>'   || privilege || '</b></font></div>' end   privilege
  , DECODE(   grantable
            , null
            , '<br>'
            , 'YES'
  ...
  , '<b><font color="#336699">' ||  HIERARCHY || '</font></b>'      HIERARCHY
FROM
    dba_tab_privs
WHERE
    grantee NOT IN (  'CTXSYS'
                      , 'DBSNMP'
                      , 'DMSYS'
                      , 'EXFSYS'
                      , 'IX'
                      ...
                      , 'ORACLE_OCM'
                      , 'PUBLIC')
    and grantee not in (select name from user$ where type#=0)
ORDER BY
    grantee
    , privilege;
...
prompt <a name="role_obj_privs"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Role Object Privileges</b></font><hr align="left" width="460">
...
SELECT
   '<font color="#336699"><b>'  || role|| '</b></font>'            role
  , '<font color="black"><b>' ||  owner || '</b></font>'           owner
  , '<font color="darkgreen"><b>' ||  table_name || '</b></font>'  table_name
  , column_name
  , CASE WHEN privilege like 'DROP%' then
            '<font color="darkred"><b>' || privilege || '</b></font>'
         ELSE
            '<font color="darkgreen"><b>'   || privilege || '</b></font>' end   privilege
  , DECODE(   grantable
            , null
            , '<br>'
            , 'YES'
...
prompt <a name="roles_user"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Role Users</b></font><hr align="left" width="460">
...
SELECT
   '<b><font color="black">' ||  b.role         || '</font></b>'          role
  , '<b><font color="#663300">'||  a.grantee    || '</font></b>'          grantee
...
prompt <a name="role_sys_privs"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Role System Privileges</b></font><hr align="left" width="460">
...
SELECT
  ...
  , CASE WHEN privilege like 'DROP%' then
            '<font color="darkred"><b>' || privilege || '</b></font>'
         ELSE
            '<font color="darkgreen"><b>'   || privilege || '</b></font>' 
    end   privilege
  , DECODE(   admin_option
            , null
            , '<br>'
...
prompt <a name="sys_user"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>System Privilege Users</b></font><hr align="left" width="460">
...
prompt <a name="user_sys"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>User System Privileges</b></font><hr align="left" width="460">
...
COLUMN tablespace_name         HEADING 'Tablespace Name'    ENTMAP off
COLUMN lob_segment_bytes       HEADING 'Segment Size'       ENTMAP off
...
prompt <center><font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#663300"><b><u>Partitions ( Table and Index)</u></b></font></center>
...
prompt <a name="part_index_detail"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Partition Index Detail</b></font><hr align="left" width="460">
...
where p.index_name=c.name
and p.index_owner=c.owner
and index_owner NOT IN (  'CTXSYS'
                      , 'DBSNMP'
                      , 'DMSYS'
                      , 'EXFSYS'
                      , 'IX'
...
prompt <a name="part_index_summary"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Partition Index Summary</b></font><hr align="left" width="460">
...
select  '<div nowrap align="left"><font color="#336699"><b>' || owner || '</b></font></div>'    owner
  ...
  , locality
  , def_tablespace_name
  ,  '<div nowrap align="center"><b>' ||partitioning_type      || '</b></div>' partitioning_type 
  ,  '<div nowrap align="center"><b>' ||partition_count        || '</b></div>' partition_count 
  ,  '<div nowrap align="center"><b>' ||subpartitioning_type   || '</b></div>' subpartitioning_type
  ,  '<div nowrap align="center"><b>' ||def_subpartition_count || '</b></div>' def_subpartition_count
from dba_part_indexes
where owner NOT IN (  'CTXSYS'
                      , 'DBSNMP'
                      , 'DMSYS'
                      , 'EXFSYS'
                      , 'IX'
...
prompt <a name="part_table_detail"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Partition Table Detail</b></font><hr align="left" width="460">
...
where p.table_name=c.name
and p.table_owner=c.owner
and table_owner NOT IN (  'CTXSYS'
                      , 'DBSNMP'
                      , 'DMSYS'
                      , 'EXFSYS'
                      , 'IX'
...
prompt <a name="part_table_summary"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Partition Table Summary</b></font><hr align="left" width="460">
...
prompt <a name="list_no_default"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>List Partition Without Default</b></font><hr align="left" width="460">
...
from (SELECT table_owner,table_name,sum(decode(substr(high_value,1,7),'default',1,0)) tips
        FROM (SELECT TABLE_OWNER,TABLE_NAME,PARTITION_NAME,
                     LONG_HELP.SUBSTR_OF('SELECT HIGH_VALUE FROM DBA_TAB_PARTITIONS 
			                 ...
			                 'TABLE_NAME',TABLE_NAME,
			                 'PARTITION_NAME',PARTITION_NAME) HIGH_VALUE
...
where v.table_owner=p.owner
  ...
  and v.table_owner NOT IN (  'CTXSYS'
                  , 'DBSNMP'
                  , 'DMSYS'
                  , 'EXFSYS'
                  , 'IX'
...
prompt <a name="range_no_maxvalue"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Range Partition Without MaxValue</b></font><hr align="left" width="460">
...
prompt <a name="global_ind_part_table"></a>
prompt <font size="+2" face="Arial,Helvetica,Geneva,sans-serif" color="#336699"><b>Global Indexes on Partition Table</b></font><hr align="left" width="460">
...
select '<div nowrap align="left"><font color="#336699"><b>' || i.owner || '</b></font></div>'    owner
    , i.index_name index_name
    , i.table_name table_name
    , i.partitioning_type partitioning_type
    , i.subpartitioning_type subpartitioning_type
    , i.def_tablespace_name tablespace_name
 from dba_part_indexes i,dba_part_tables t
where i.owner=t.owner 
  and i.table_name=t.table_name
  and i.locality='GLOBAL'
  and i.owner NOT IN (  'CTXSYS'
                      , 'DBSNMP'
                      , 'DMSYS'
                      , 'EXFSYS'
                      , 'IX'
...
SELECT
  ...
  , '<div nowrap align="right">' || TO_CHAR(m.last_refresh_date, 'yyyy-mm-dd HH24:MI:SS') || '</div>'  last_refresh_date
...
SELECT
  ...
  , '<div align="center" nowrap>' || TO_CHAR(sl.start_time,'yyyy-mm-dd HH24:MI:SS') || '</div>'  start_time
...
SELECT
  ...
  , decode(broken, 'Y', 'Broken', 'Normal')         status
  , '<div nowrap align="right">' || NVL(TO_CHAR(s.next_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'   next_date
  , s.interval                                      interval 
FROM
    sys.defschedule   s
  , sys.dba_jobs      j 
...
SELECT
  ...
  , decode(j.broken, 'Y', 'Broken', 'Normal')      broken
  , '<div nowrap align="right">' || NVL(TO_CHAR(j.next_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'   next_date
...
SELECT
  ...
  , '<div nowrap align="right">' || NVL(TO_CHAR(m.last_refresh_date, 'yyyy-mm-dd HH24:MI:SS'), '<br>') || '</div>'   last_refresh
FROM
    sys.dba_snapshots  s
  , sys.dba_mviews     m 
WHERE
