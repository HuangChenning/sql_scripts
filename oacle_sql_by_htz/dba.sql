...
--
--------------------------------------------------------------------------------
ACCEPT dba prompt 'Enter Search Dba  (i.e. A60DA000) : ' default ''
...
select 
	dbms_utility.data_block_address_file(to_number('&dba','XXXXXXXXXX')) RFILE#, 
	dbms_utility.data_block_address_block(to_number('&dba','XXXXXXXXXX')) BLOCK#,
  '-- alter system dump datafile '||dbms_utility.data_block_address_file(to_number('&dba','XXXXXXXXXX'))
  ||' block '||dbms_utility.data_block_address_block(to_number('&dba','XXXXXXXXXX')) dump_cmd
from dual;
