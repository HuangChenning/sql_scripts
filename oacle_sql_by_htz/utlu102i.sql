Rem
Rem $Header: rdbms/admin/utlu102i.sql /st_rdbms_10.2/23 2008/10/15 11:41:37 cdilling Exp $
Rem
Rem utlu102i.sql
Rem
...
Rem    bmccarth    10/20/10 - Update for My Oracle Support:
Rem                         - Cursor_space_for_time is deprecated (9571646)
Rem                         - Calibrate tablespace sizes for 10.2.0.5
Rem                         -  bug 9174373 - flag sga_target if lower Oracle is
Rem                           102 and user had set it to less than minimum value
Rem                         - Invalid Object update
...
-- *****************************************************************
  ...
  utlu_banner      CONSTANT VARCHAR2(50) := 'Oracle Database 10.2 Pre-Upgrade Information Tool ';
  utlu_version     CONSTANT VARCHAR2(30) := '10.2.0.4';
