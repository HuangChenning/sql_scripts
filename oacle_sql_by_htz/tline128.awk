...
# Improvements:
# 
# Please notify me of any bugs or enhancements. My email id is :
# kevin.p.quinn@oracle.com
#
# To Do:
...
{
 printf("%*s %-30s %s\n", datelen,
   curdate, substr(str,1,30), curfile);
}
...
titlestr="tline.awk Version V1.2.8. Source file=";
sep="------------------------------------------------------------------------";
