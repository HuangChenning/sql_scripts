...
accept sql_id1 -
       prompt 'Enter value for sql_id1(old_sql): ' -
       default 'X0X0X0X0'
accept child_no1 -
       prompt 'Enter value for child_no1 (old_sql) (0): ' -
       default '0'
accept sql_id2 -
       prompt 'Enter value for sql_id2(new_sql): ' -
       default '&&sql_id1'
accept child_no2 -
       prompt 'Enter value for child_no2(new_sql) (0): ' -
       default '0'
accept profile_name -
