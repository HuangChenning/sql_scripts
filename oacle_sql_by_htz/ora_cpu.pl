#! /usr/bin/perl -w
#######################################################################
# Script displays CPU statistics for ORACLE processes running under AIX
...
Display AIX and ORACLE Statistics for Active ORACLE Processes on AIX
...
#-----------------------------------------------------------------------
# Get "Default" Domain Name(s) (only verified on AIX)
#-----------------------------------------------------------------------
