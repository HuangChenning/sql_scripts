...
-- Oracle Support document ID 1296168.1
...
-- 9-6-11 SGEORGE - updated queries and removeed "COMPRESS_FOR" from compression queries.  Compatable with Oracle 10g and 11g
...
-- 12-7-11 SGEORGE - Added check for tables with NOLOGGING. Tables with the NOLOGGING option may cause problems  
...
SELECT '------ Integrated Extract unsupported objects in '||:b0
FROM dual;
Set heading on 
