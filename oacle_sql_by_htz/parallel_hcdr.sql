...
REM
REM $Header: 1460440.1 pxhcdr.sql 11.4.4.8 2012/09/27 carlos.sierra $
REM
...
REM   SQL> START [path]pxhcdr.sql [T|D|N]
REM
REM NOTES
...
DEF doc_ver = '11.4.4.8';
DEF doc_date = '2012/09/27';
...
-- main zip
HOS zip -mT ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._^^time_stamp..zip ^^script._^^database_name_short._^^host_name_short._^^rdbms_version._*^^time_stamp.*
