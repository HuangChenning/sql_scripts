...
REM
REM WARNING:  On very large Shared Pools, there have been reports 
REM on 10g and 11g of this query running for long periods of time
REM and at times causing hangs.  The point of the V$ view here
REM was to eliminate that problem, but it appears there can be 
REM problems in some cases.  Run this with caution in very busy
REM production system!!
REM
